...
class ParlamentarController {
    async viewParlamentares(req, res){
        ...
        res.render("user/parlamentar/ParlamentaresPage", { parlamentares: parlamentarOrder });
    }
    ...
    async viewHistoricoParlamentares(req, res){
        ...
        res.render("user/parlamentar/parlamentaresHistoricoPage", { parlamentaresAtuais, parlamentaresAntigos });
    }
    ...
    async viewParlamentarById(req, res){
        ...
        res.render("user/parlamentar/ParlamentarIdPage", { parlamentar, pagination });
    }
