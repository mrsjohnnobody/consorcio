                    ...
                    if(result.status === 'success') {
                        ...
                        let newRow = `
                            <tr id="sessaoIdItem_${result.sessao.id}">
                                ...
                                <td>
                                    ${result.sessao.Data != "0000-00-00" ? new Date(result.sessao.Data).toLocaleDateString('pt-BR', { timeZone: 'UTC' }) : ""}
                                </td>
                                <td>
                                ...
                                <td scope="row">
                                    <a href="/admin/editSessao/${result.sessao.id}" style="text-decoration: none;">
                                        <img title="Editar Sessão" src="/icons/pencil-fill.svg" alt="Editar Sessão" height="20rem">
                                    </a>
                                    &nbsp;
                                    <span style="text-decoration: none; cursor: pointer;" onClick="setIdForRemoveSessao('${result.sessao.id}')" data-bs-toggle="modal" data-bs-target="#deleteModal">
                    ...
                    if(result.status === 'success') {
                        ...
                        result.sessoes.forEach(sessao => {
                            ...
                            <tr id="sessaoIdItem_${sessao.id}" class="sessaoItem">
                                ...
                                <td scope="row">
                                    <a href="/admin/editSessao/${sessao.id}" style="text-decoration: none;">
                                        <img title="Editar Sessão" src="/icons/pencil-fill.svg" alt="Editar Sessão" height="20rem">
                                    </a>
                                    &nbsp;
                                    <span style="text-decoration: none; cursor: pointer;" onClick="setIdForRemoveSessao('${sessao.id}')" data-bs-toggle="modal" data-bs-target="#deleteModal">
                                        <img title="Excluir sessão" src="/icons/x-circle-fill.svg" alt="Excluir sessão" height="20rem">
                                    </span>
                                </td>
                            </tr>
